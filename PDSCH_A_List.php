                        ...
                        <div class='table-responsive'>
                            <table class='table table-bordered table-hover' id='myTable' style='width:100%;' align="center">
                                ...
                                <tbody>
                                    ...
                                    $strSql .= "AND [Actual start date] = '" . $_POST['param_dDate'] . "' ";
                            ...
                            <form method='post' id='insert-pdsch-form'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-danger">
                                        <label>Revise - Actual Start Date</label>
                                        <input type="date" id="revactualStartDate" name="revactualStartDate" class='form-control' required>
                                    </div>

                                    <div class="col-lg-4 text-danger">
                                        <label>Revise - Actual Start Time</label>
                                        <input type="time" id="revactualStartTime" name="revactualStartTime" class='form-control' required>
                                    </div>
                                </div>
                    ...
                    $('.edit_pdsch_data').click(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $('#revactualStartDate').val(data['Actual start date']);
                                $('#revactualStartTime').val( data['Actual start time'].replace(".0000000", "") );
